...
CREATE PROCEDURE &SCHEMAOWNER.dataMigrationFrom2020300To2021100_Messages
(
...
BEGIN
	...
	--IDENTITY_INSERT &SCHEMAOWNER.MS_TAG OFF
	...
	BEGIN  -- (lv_BatchSize > 0)
        ...
        LOOP
            BEGIN
                ...
                END IF;   
                -- IDENTITY INSERT ON
                -- IDENTITY_INSERT &SCHEMAOWNER.MS_MSG_HDR ON
                ...
                --IDENTITY_INSERT &SCHEMAOWNER.MS_MSG_HDR OFF
    
                -- Migrate EVENTS
    
                --IDENTITY_INSERT &SCHEMAOWNER.MS_MSG_EVNT ON
                ...
                --IDENTITY_INSERT &SCHEMAOWNER.MS_MSG_EVNT OFF
